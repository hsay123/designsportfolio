    ...
    >
      <div className="relative w-[155px] h-[155px] transition-all duration-300 group-hover:drop-shadow-[0_8px_16px_rgba(0,0,0,0.25)]">
        ...
        <img
          ...
          className="absolute left-1/2 bottom-[30%] w-[105px] h-auto object-contain -translate-x-1/2 transition-all duration-500 ease-out opacity-0 group-hover:opacity-100 group-hover:-translate-y-[30px] group-hover:-translate-x-[140px] group-hover:rotate-[-15deg] z-10"
