...
const aiProjects = [
  {
    ...
    detail: "Winner- A Stellar-based platform enabling NGOs & governments to distribute financial aid using programmable wallets + stablecoins",
    tags: [{ label: "Winner", color: "#9a8058", bg: "#f2ead8" }],
  },
  {
    year: "2025",
    title: "GDG Hackathon",
    detail: "Winner- IPX Market is a decentralized marketplace for AI datasets ",
    tags: [{ label: "Winner", color: "#9a8058", bg: "#f2ead8" }],
  },
  {
    year: "2025",
    title: "ShadowFax",
    detail: "Software Engineering Intern — Built and deployed full-stack web applications using MongoDB, Express, React, and Node.js",
    tags: [{ label: "Intern", color: "#6b7a5e", bg: "#e6ebdd" }],
  },
  {
    year: "2026",
    title: "SSOC (Social Summer of Code)",
    detail: "Open Source Contributor — Open Source Contributor at SSOC • Delivered features, fixed bugs, and merged PRs across community projects.",
    tags: [{ label: "OPEN SOURCE", color: "#5f7a8a", bg: "#e2ebee" }],
  },
  {
    year: "2026",
    title: "Midnight Fellowship",
    detail: "Fellow — Built privacy first Web3 applications as a Midnight Fellow.",
