...
import { BULLETIN_VERSIONS } from "./bulletin-versions";

/* ── Board images data ── */
function versioned(src: string): string {
  const v = BULLETIN_VERSIONS[src];
  return v ? `${src}?v=${v}` : src;
}
const BOARD_IMAGES = [
  { src: versioned("/bulletin/1.png"), top: "1%", left: "8%", rotate: "-5deg", w: 220, z: 1, side: "left" as const, startVY: 0.1, label: "Search trend tools (GettyImages & iStock)" },
  { src: versioned("/bulletin/6.png"), top: "3%", left: "32%", rotate: "-2deg", w: 250, z: 1, side: "left" as const, startVY: 0.05, label: "50 emojis (Figma design)" },
  { src: versioned("/bulletin/2.png"), top: "4%", left: "55%", rotate: "3deg", w: 210, z: 1, side: "right" as const, startVY: 0.15, label: "Contribution submission app (GettyImages & iStock)" },
  { src: versioned("/bulletin/10.jpeg"), top: "2%", left: "80%", rotate: "6deg", w: 235, z: 1, side: "right" as const, startVY: 0.2, label: "Abstract poster/wallpaper (Figma design)" },
  { src: versioned("/bulletin/11.jpeg"), top: "30%", left: "2%", rotate: "4deg", w: 215, z: 1, side: "left" as const, startVY: 0.4, label: "Claude Design experiments" },
  { src: versioned("/bulletin/5.png"), top: "28%", left: "26%", rotate: "6deg", w: 270, z: 3, side: "right" as const, startVY: 0.35, label: "yanliuos (Claude Code)" },
  { src: versioned("/bulletin/3.png"), top: "33%", left: "52%", rotate: "2deg", w: 340, z: 1, side: "right" as const, startVY: 0.45, label: "Vibe coding playlist (Claude Code)" },
  { src: versioned("/bulletin/9.jpeg"), top: "30%", left: "78%", rotate: "-4deg", w: 260, z: 1, side: "right" as const, startVY: 0.5, label: "Food delivery app (Figma design)" },
  { src: versioned("/bulletin/7.png"), top: "72%", left: "5%", rotate: "-3deg", w: 240, z: 1, side: "left" as const, startVY: 0.7, label: "Abstract elements (Figma design)" },
  { src: versioned("/bulletin/12.png"), top: "70%", left: "32%", rotate: "-3deg", w: 270, z: 1, side: "right" as const, startVY: 0.7, label: "[PLACEHOLDER: describe what this image shows]" },
  { src: versioned("/bulletin/8.png"), top: "70%", left: "63%", rotate: "5deg", w: 300, z: 2, side: "right" as const, startVY: 0.65, label: "3D cabin (Claude Artifact)" },
  { src: versioned("/bulletin/4.png"), top: "50%", left: "30%", rotate: "-3deg", w: 240, z: 2, side: "left" as const, startVY: 0.5, label: "[PLACEHOLDER: describe what this image shows]" },
];
